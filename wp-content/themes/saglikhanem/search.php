...
<div id="page" class="home-<?php echo $mts_options['mts_home_layout']; ?>">
	<div id="content_box">
		<h1 class="postsby">
			<span class="aranan-kelime">"<?php the_search_query(); ?>"</span><?php _e("  için uygun bulunanlar.", 'sociallyviral' ); ?>
		</h1>
		...
		<?php $j++; endwhile; else: ?>
			<div class="no-results">
				<h2><?php _e('Üzgünüz, aradığınız kelimede hiçbir eşleşme bulamadık. Dilerseniz başka kelimeyle aramaya devam edebilirsiniz.', 'sociallyviral' ); ?></h2>
				<?php get_search_form(); ?>
			</div><!--noResults-->
		<?php endif; ?>
