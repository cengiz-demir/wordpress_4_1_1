				...
				<div id="post-<?php the_ID(); ?>" <?php post_class('g post'); ?>>
					...
					foreach( $single_post_parts as $part => $label ) { 
						switch ($part) {
								...
								<div class="single_post">
										...
										<?php if ( ! empty( $mts_options["mts_single_headline_meta"] ) ) { ?>
					                        <div class="post-info">
					                            ...
					                            <?php if( ! empty( $mts_options["mts_single_headline_meta_info"]['date']) ) { ?>
					                                <span class="thetime date updated"><i class="fa fa-calendar"></i> <span><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . __(' önce','sociallyviral'); ?></span></span>
					                            <?php } ?>
					                            <?php if( ! empty( $mts_options["mts_single_headline_meta_info"]['comment']) ) { ?>
					                                <span class="thecomment"><i class="fa fa-comments"></i> <a rel="nofollow" href="<?php comments_link(); ?>" title="<?php echo comments_number();?> yorum yapılmış." itemprop="interactionCount"><?php echo comments_number();?></a></span>
					                            <?php } ?>
					                        </div>
			                   			<?php } ?>
									...
									<div class="post-single-content box mark-links entry-content">
										...
										<div class="single-prev-next">
											<?php previous_post_link('%link', '<i class="fa fa-long-arrow-left"></i> '.__('Önceki Yazı','sociallyviral')); ?>
											<?php next_post_link('%link', __('Sonraki Yazı','sociallyviral').' <i class="fa fa-long-arrow-right"></i>'); ?>
										</div>
										...
										<?php wp_link_pages(array('before' => '<div class="pagination">', 'after' => '</div>', 'link_before'  => '<span class="current"><span class="currenttext">', 'link_after' => '</span></span>', 'next_or_number' => 'next_and_number', 'nextpagelink' => __('Sonraki', 'sociallyviral' ), 'previouspagelink' => __('Önceki', 'sociallyviral' ), 'pagelink' => '%','echo' => 1 )); ?>
							...
							case 'tags':
								?>
								<?php mts_the_tags('<span class="tagtext">'.__('Etiketler', 'sociallyviral' ).':</span>',', ') ?>
								<?php
							break;
							...
							case 'author':
								...
								<div class="postauthor">
									...
									<div class="author-wrap">
										...
										<span class="author-posts"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" rel="nofollow"><?php _e('Yazarın diğer yazıları','sociallyviral'); ?> <i class="fa fa-angle-double-right"></i></a></span>
